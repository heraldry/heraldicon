...
(defn pale
  ...
  (let [{:keys [line origin geometry]}                          (options/sanitize ordinary (options ordinary))
        ...
        field                                                   (if (charge/counterchangable? field parent)
                                                                  ...
                                                                  field)
        [fimbriation-elements-left fimbriation-outlines-left]   (render-fimbriation
                                                                 [first-bottom :bottom]
                                                                 [first-top :top]
                                                                 [line-one-data]
                                                                 (:fimbriation line)
                                                                 render-options)
        [fimbriation-elements-right fimbriation-outlines-right] (render-fimbriation
                                                                 [second-top :top]
...
(defn fess
  ...
  (let [{:keys [line origin geometry]}                            (options/sanitize ordinary (options ordinary))
        ...
        field                                                     (if (charge/counterchangable? field parent)
                                                                    (charge/counterchange-field field parent)
                                                                    field)
        [fimbriation-elements-top fimbriation-outlines-top]       (render-fimbriation
                                                                   [first-left :left]
                                                                   [first-right :right]
                                                                   [line-one-data]
                                                                   (:fimbriation line)
                                                                   render-options)
        [fimbriation-elements-bottom fimbriation-outlines-bottom] (render-fimbriation
                                                                   [second-right :right]
                                                                   [second-left :left]
                                                                   [line-reversed-data]
                                                                   (:fimbriation opposite-line)
...
(defn chief
  ...
  (let [{:keys [line geometry]}                     (options/sanitize ordinary (options ordinary))
        ...
        field                                       (if (charge/counterchangable? field parent)
                                                      (charge/counterchange-field field parent)
                                                      field)
        [fimbriation-elements fimbriation-outlines] (render-fimbriation
                                                     [row-right :right]
                                                     [row-left :left]
                                                     [line-reversed-data]
                                                     (:fimbriation line)
...
(defn cross
  ...
  (let [{:keys [line origin geometry]}                              (options/sanitize ordinary (options ordinary))
        ...
        field                                                       (if (charge/counterchangable? field parent)
                                                                      (charge/counterchange-field field parent)
                                                                      field)
        [fimbriation-elements-1 fimbriation-outlines-1]             (render-fimbriation
                                                                     [fess-top-left :left]
                                                                     [pale-top-left :top]
                                                                     ...
                                                                     (:fimbriation line)
                                                                     render-options)
        [fimbriation-elements-2 fimbriation-outlines-2]             (render-fimbriation
                                                                     [pale-top-right :top]
                                                                     ...
                                                                     (:fimbriation line)
                                                                     render-options)
        [fimbriation-elements-3 fimbriation-outlines-3]             (render-fimbriation
                                                                     ...
                                                                     (:fimbriation line)
                                                                     render-options)
        [fimbriation-elements-4 fimbriation-outlines-4]             (render-fimbriation
...
(defn saltire
  ...
  (let [{:keys [line origin diagonal-mode geometry]}                  (options/sanitize ordinary (options ordinary))
        ...
        _                                                             (println "oi" joint-angle-horizontal joint-angle-vertical)
        ...
        {line-top-left-lower        :line
         line-top-left-lower-offset :start-offset
        ...
        {line-top-left-upper        :line
         line-top-left-upper-offset :start-offset
        ...
        {line-top-right-upper        :line
         line-top-right-upper-offset :start-offset
        ...
        {line-top-right-lower        :line
         line-top-right-lower-offset :start-offset
...
(defn chevron
  ...
  (let [{:keys [line origin diagonal-mode geometry]}            (options/sanitize ordinary (options ordinary))
        ...
        {line-right-upper        :line
         line-right-upper-offset :start-offset
        ...
        {line-right-lower        :line
         line-right-lower-offset :start-offset
        ...
        {line-left-lower        :line
         line-left-lower-offset :start-offset
        ...
        {line-left-upper        :line
         line-left-upper-offset :start-offset
        ...
        parts                                                   [[["M" (v/+ corner-upper
                                                                   ...
                                                                   (infinity/path :clockwise
                                                                                  ...
                                                                                  [(v/+ right-upper
                                                                                        line-right-upper-offset)
                                                                                   (v/+ right-lower
                                                                                        line-right-lower-offset)])
                                                                   (line/stitch line-right-lower)
                                                                   "L" (v/+ corner-lower
                                                                            line-left-lower-offset)
        ...
        field                                                   (if (charge/counterchangable? field parent)
                                                                  (charge/counterchange-field field parent)
                                                                  field)
        [fimbriation-elements-upper fimbriation-outlines-upper] (render-fimbriation
                                                                 [left-upper :left]
                                                                 [right-upper :right]
                                                                 ...
                                                                 (:fimbriation line)
                                                                 render-options)
        [fimbriation-elements-lower fimbriation-outlines-lower] (render-fimbriation
                                                                 [right-lower :bottom]
                                                                 [left-lower :bottom]
