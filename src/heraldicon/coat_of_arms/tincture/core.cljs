(ns heraldicon.coat-of-arms.tincture.core
  (:require
   [clojure.string :as s]
   [heraldicon.coat-of-arms.hatching :as hatching]
   [heraldicon.coat-of-arms.tincture.pattern :as pattern]
   [heraldicon.coat-of-arms.tincture.theme :as theme]
